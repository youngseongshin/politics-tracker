...
- T9.4 정성 내용 분석 개편: T9.1의 전수 탐지는 분석 대상의 경계를 정하는 용도로만
  ...
  **완료(2026-08-17):** 최초 공개본의 직접 언급 918건을 읽은 뒤 재배포에서 새로
  확인된 발언을 직전 산출물과 ID로 대조했다. 현재 모집단 1,002건을 모두 검토하고
...
- 근거 규칙: 정성 분석 문장은 등록된 발언 ID 목록과 함께 관리한다. 빌드할 때 모든
  ...
  **구현(2026-08-17):** 사람이 작성한 보고서를 `analytics/data/ai_qualitative.yaml`에
  두고 49개 대표 발언 ID와 근거 구절을 등록했다. 각 논점은 화자 3명 이상, 회의 3건
...
- 완료 기준: 최소 7개 주요 논점과 각 논점당 3건 이상의 고유 근거를 제시한다. 근거는
  ...
  **충족(2026-08-17):** 8월 12일까지의 1,002건을 검토한 보고서에 12개 논점과 대표
  근거 49건을 등록했다. 모든 근거의 ID·구절·출처를 최신 공개 회의록 문맥에 다시
