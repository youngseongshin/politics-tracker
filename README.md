...
Claude 백엔드를 선택할 수 있습니다. AI 관련 발언은 결정적 규칙으로 전건을 찾아
주제별·월별 분포와 근거 문맥을 한 페이지에서 공개합니다.
...
├── analytics/
│   └── ai_mentions.py    AI 언급 탐지·다중 주제 분류·시간순 집계
...
- **Phase 3 (완료)**: 공약 추적, 예측 채점, 외부 팩트체크, 정정 채널,
  공개 방법론과 균형 감사
- **M9 (완료)**: AI 언급 전건의 주제별·월별 시각화와 원문 근거 목록
